...
PKG_NAME="sandbox-spawner-0.1.0"
PKG_SHORT_NAME="sandbox-spawner"
...
# Exceuting rpmbuild
rpmbuild --define "_topdir ${CMAKE_BINARY_DIR}" -ba "${CMAKE_SOURCE_DIR}/resources/rpm_specs/sandbox-spawner.spec"
